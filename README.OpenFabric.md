...
> [!NOTE]
>
> OpenFabricでは末端のスイッチがTier0で、コア側に行くほどTierの数字が上がります
>
...
R1からみて同じTierのR2、R3には4本の等コストパスがあります。
...
ネクストホップが隣接ルータのループバックアドレスになっています。
...
> [!NOTE]
>
> BGPの場合はRFC5549でIPv4経路のネクストホップをIPv6アドレスにするための仕組みが規定されています。
>
> RFC 5549 - Advertising IPv4 Network Layer Reachability Information with an IPv6 Next Hop

<br>

ネクストホップがループバックのアドレスになってしまっているので、どうやって隣接ルータに到達するためのMACアドレスを知るのか、疑問が生じます。

実際に通信をキャプチャして確かめてみました。

ループバックを解決するためのARP Requestが発信されて、ちゃんと隣接ルータはそれに答えていました。
